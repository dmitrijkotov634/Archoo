...
let
    confPath = getConfigDir() & "archoo/main.conf"
    colors = {
        "red" : "\e[31m",
        "green" : "\e[32m",
        "yellow" : "\e[33m",
...
const
    confDefault = """blue
hostname..kernel..packages..uptime..ram..shell..user
${blue}               +                    
${blue}               #                    
${blue}              ###                   
${blue}             #####                  
...
try:
    ...
    discard execProcess("mkdir -p ~/.config/archoo/")
...
for n, str in logo:
    if n < modules.len:
        ...
        of "user": result = &"{color}User\e[0m: " & execProcess("whoami")[0..^2]
        of "ram":
